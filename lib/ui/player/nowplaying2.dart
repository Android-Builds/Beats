...
class NowPlaying2 extends StatefulWidget {
  final String songId;
  final bool newSong;
  const NowPlaying2({Key key, @required this.songId, this.newSong = false})
      : super(key: key);
  @override
  _NowPlaying2State createState() => _NowPlaying2State(songId, newSong);
}
...
class _NowPlaying2State extends State<NowPlaying2> {
  ...
  _NowPlaying2State(this.songId, this.newSong);
